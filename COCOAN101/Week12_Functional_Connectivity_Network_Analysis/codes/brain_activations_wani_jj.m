function [out, o2] = brain_activations_wani_jj(r, varargin)
...
if ~do_color
    ...
    for i = 1:numel(r)
        o2 = addblobs(o2, r(i), 'color', color{i}); % A&B
    end
end
    ...
    case 'left'
        ...
        if ~do_color
            switch surface_style
                case 'inflated'
                    out.h_surf_L = cluster_surf_jj(r ,which('surf_workbench_inflated_32k_Left.mat'), depth, 'heatmap', 'colormaps', poscm, negcm, 'noverbose');
                case 'veryinflated'
                    out.h_surf_L = cluster_surf_jj(r, 'fsavg_left', depth, 'heatmap', 'colormaps', poscm, negcm, 'noverbose');
                case 'veryinflated_wb'
                    out.h_surf_L = cluster_surf_jj(r ,which('surf_workbench_very_inflated_32k_Left.mat'), depth, 'heatmap', 'colormaps', poscm, negcm, 'noverbose');
            end
        else
            switch surface_style
                case 'inflated'
                    out.h_surf_L = cluster_surf_jj(r ,which('surf_workbench_inflated_32k_Left.mat'), depth, color, 'noverbose');
                case 'veryinflated'
                    out.h_surf_L = cluster_surf_jj(r, 'fsavg_left', depth, color, 'noverbose');
                case 'veryinflated_wb'
                    out.h_surf_L = cluster_surf_jj(r ,which('surf_workbench_very_inflated_32k_Left.mat'), depth, color, 'noverbose');
            end
        end
    case 'right'
        ...
        if ~do_color
            switch surface_style
                case 'inflated'
                    out.h_surf_R = cluster_surf_jj(r ,which('surf_workbench_inflated_32k_Right.mat'), depth, 'heatmap', 'colormaps', poscm, negcm, 'noverbose');
                case 'veryinflated'
                    out.h_surf_R = cluster_surf_jj(r, 'fsavg_right', depth, 'heatmap', 'colormaps', poscm, negcm, 'noverbose');
                case 'veryinflated_wb'
                    out.h_surf_R = cluster_surf_jj(r ,which('surf_workbench_very_inflated_32k_Right.mat'), depth, 'heatmap', 'colormaps', poscm, negcm, 'noverbose');
            end
        else
            switch surface_style
                case 'inflated'
                    out.h_surf_R = cluster_surf_jj(r ,which('surf_workbench_inflated_32k_Right.mat'), depth, color, 'noverbose');
                case 'veryinflated'
                    out.h_surf_R = cluster_surf_jj(r, 'fsavg_right', depth, color, 'noverbose');
                case 'veryinflated_wb'
                    out.h_surf_R = cluster_surf_jj(r ,which('surf_workbench_very_inflated_32k_Right.mat'), depth, color, 'noverbose');
            end
        end
end
